  ...
  export default {
    ...
    methods:{
      ...
      colorB:function (i) {
        ...
        document.getElementsByClassName('nav-center')[i].style.backgroundColor='#ccc';
        axios.get('http://192.168.0.114:8080/comment?i=2').then(resp =>{
          let data = resp.data;
      ...
      colorC:function (i) {
        ...
        document.getElementsByClassName('nav-center')[i].style.backgroundColor='#ccc';
        axios.get('http://192.168.0.114:8080/comment?i=3').then(resp =>{
          let data = resp.data;
      ...
      colorD:function (i) {
        ...
        document.getElementsByClassName('nav-center')[i].style.backgroundColor='#ccc';
        axios.get('http://192.168.0.114:8080/comment?i=4').then(resp =>{
          let data = resp.data;
    ...
    _initData: function () {
      axios.get('http://192.168.0.114:8080/rener/comment?i=1').then(resp =>{
        let data = resp.data;
